package com.icw.blog.web.rest;

import com.icw.blog.IcwblogApp;
import com.icw.blog.domain.Blog;
import com.icw.blog.repository.BlogRepository;
 ...
 */
@SpringBootTest(classes = IcwblogApp.class)
...
//        assertThat(testBlog.getUserId()).isEqualTo(DEFAULT_USER_ID);
//    }
//
//    @Test
//    @Transactional
...
//        assertThat(testBlog.getUserId()).isEqualTo(UPDATED_USER_ID);
//    }
//
//    @Test
//    @Transactional
