...
export const Blog = (props: IBlogProps) => {
  ...
  return (
    <div>
      <h2 id="blog-heading">
        <Translate contentKey="icwgatewayApp.blog.home.title">Blogs</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="icwgatewayApp.blog.home.createLabel">Create new Blog</Translate>
        </Link>
      </h2>
        ...
        {blogList && blogList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="icwgatewayApp.blog.home.notFound">No Blogs found</Translate>
            </div>
          )
        )}
      </div>
