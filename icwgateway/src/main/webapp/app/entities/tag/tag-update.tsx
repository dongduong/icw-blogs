  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="icwgatewayApp.tag.home.createOrEditLabel">
            <Translate contentKey="icwgatewayApp.tag.home.createOrEditLabel">Create or edit a Tag</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : tagEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="tag-name">
                  <Translate contentKey="icwgatewayApp.tag.name">Name</Translate>
                </Label>
                <AvField
                  id="tag-name"
                  type="text"
